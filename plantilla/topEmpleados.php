...
<head>
    ...
    <meta name="url-diagnostico" content="<?php echo $URL; ?>">
...
<nav class="navbar navbar-expand-lg navbar-dark" id="header">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown">
                <?php include('../empleados/controles/Control_notificaciones.php'); ?>
                                ...
                                <?php if ($count > 0): ?>
                                    <?php foreach ($notificaciones as $row): ?>
                                        <div class="dropdown-item notification-item d-flex align-items-center" style="background-color: var(--notification-bg-color, #1a3a6a);">
                                            <a href="<?php echo $URL; ?>empleados/VerificarDiseños.php?Codigo=<?php echo $row['Id_pedido']; ?>" class="text-decoration-none w-100">
