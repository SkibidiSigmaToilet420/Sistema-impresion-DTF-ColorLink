...
<head>
    ...
    <!-- modal_notificaciones removed: now using inline dropdown scroll (no modal) -->
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark" id="header">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="<?php echo $URL; ?>admin/index.php">
            ...
            <div class="d-flex align-items-center">
                <?php include '../admin/Controles/Control_notificaciones.php'; ?>
                ...
                <ul class="dropdown-menu dropdown-menu-end p-0 dropdown-menu-notif" aria-labelledby="dropdownNotificaciones" style="min-width:340px; max-width:95vw;">
                    <li class="nav-link text-light d-flex justify-content-between align-items-center">
                        ...
                        <form action="<?php echo $URL; ?>admin/Controles/Borrar_notificaciones.php" method="post" style="display:inline; margin-left: 10px;">
                                ...
                                <?php if ($count > 0): ?>
                                    <?php foreach ($notificaciones as $row): ?>
                                        <div class="dropdown-item notification-item d-flex align-items-center" style="background-color: var(--notification-bg-color, #1a3a6a);">
                                            <a href="<?php echo $URL; ?>admin/PedidoDiseños.php?Codigo=<?php echo $row['Id_pedido']; ?>" class="text-decoration-none w-100">
                    ...
                    <div class="d-flex flex-column flex-shrink-0 p-3 h-100">
                        <ul class="nav nav-pills flex-column mb-auto">
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/index.php" class="nav-link text-light">
                                    <i class="fa-solid fa-house"></i> Inicio
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/usuarios.php" class="nav-link text-light">
                                    <i class="fa-solid fa-users"></i> Usuarios
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/usuariosBorrados.php" class="nav-link text-light">
                                    <i class="fa-solid fa-user-slash"></i> Usuarios Desactivados
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/Administradores.php" class="nav-link text-light">
                                    <i class="fa-solid fa-crown"></i> Administradores
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/empleados.php" class="nav-link text-light">
                                    <i class="fa-solid fa-user-tie"></i> Empleados
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/Clientes.php" class="nav-link text-light">
                                    <i class="fa-solid fa-user"></i> Clientes
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="<?php echo $URL; ?>admin/Pedidos.php" class="nav-link text-light">
                                    <i class="fa-solid fa-truck"></i> Pedidos
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo $URL; ?>admin/Diseños.php" class="nav-link text-light">
                                    <i class="fa-solid fa-file-image"></i> Diseños
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo $URL; ?>admin/Material.php" class="nav-link text-light">
