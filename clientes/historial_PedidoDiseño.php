...
<div class="col-lg-10 ms-sm-auto px-4 py-4">
        ...
        <div class="d-flex justify-content-end mb-3">
            <form class="d-flex" method="GET" action="historial_PedidoDiseño.php">
                <input type="hidden" name="Codigo" value="<?php echo htmlspecialchars($codigo); ?>">
                <input type="search" name="q" class="form-control form-control-sm me-2" placeholder="Buscar diseños..." value="<?php echo htmlspecialchars($q); ?>">
